...
#define MATRIX_HEIGHT     		32			// LED matrix height (#leds)
#define MATRIX_DATA_PIN    		5			// ESP32 -> LED matrix data buffer GPIO pin
...
// Bluetooth Buffer Time Variables
#define BT_CONNECTION			3000		        // 3000 ms
#define BLINK_INTERVAL			100			// 100 ms, bluetooth led blink interval
